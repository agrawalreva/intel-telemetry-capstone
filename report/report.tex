...
\begin{itemize}
    \item \textbf{Reva Agrawal}: Carried out the exploration of the 22 SQL queries to identify the tables and columns required to build the specialized schema. Confirmed the pipeline with the project advisor and debugged its implementation. Wrote various sections of the report based on progressive work over the course of the project.
